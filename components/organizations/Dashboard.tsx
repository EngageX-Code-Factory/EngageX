  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">Here is what is happening with your club today.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">Once students register for your events, they will appear here.</p>
        </div>
      </div>
